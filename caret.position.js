...
const position = (element) => {
  ...
  caret = isContentEditable(element) ? new EditableCaret(element) : new InputCaret(element);
...
EditableCaret.prototype.getPosition = function () {
  ...
  inputor_offset = getOffsetUtils(this.domInputor);
...
InputCaret.prototype.getIEPosition = function (pos) {
  ...
  offset = this.getIEOffset(pos);
  inputorOffset = getOffsetUtils(this.domInputor);
...
Mirror.prototype.rect = function () {
  ...
  var rect = { left: pos.left, top: pos.top, height: flag.offsetHeight };
